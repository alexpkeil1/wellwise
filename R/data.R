...
#'   \item{Hexavalent_Chromium}{Hexavalent Chromium measurement}
#'   \item{Insoluble_Iron}{Insoluble Iron measurement}
...
#'   \item{Soluble_Iron}{Soluble Iron measurement}
#'   \item{Sulfate}{Sulfate measurement}
#'   \item{Total_Alkalinity}{Total Alkalinity measurement}
#'   \item{Total_Hardness}{Total Hardness measurement}
